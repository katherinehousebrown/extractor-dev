...
export MACH_NAME="extractor-tc-ops"
export ARCHIVE_NAME="extractor-TC-OPS.tgz"

export BCKT_EAST="ods-sa-o1"
export BCKT_WEST="ods-sa-o2"
export XFER_BCKT_EAST="ods-sa-01/Reservoir_Dogs/Diode_Transfer_Service/UC-TC"
export XFER_BCKT_WEST="ods-sa-02/Reservoir_Dogs/Diode_Transfer_Service/UC-TC"
######################################################################
...
#docker exec extractor-tc-ops bash -c 'cd /extractor; nose2 > nose2 --plugin nose2.plugins.junitxml --junit-xml'
#docker exec extractor-tc-ops bash -c 'newman run -e /extractor/test/local.postman_environment.json /extractor/test/guid.postman_collection.json > /extractor/test/newman.out'
#Copy Reports to Jenkins Server
echo "Copying Junit Reports"
#docker cp extractor-tc-ops:/extractor/nose2-junit.xml nose2-junit.xml
echo ""
echo ""
echo ""
...
aws s3 cp cloudFormation/ops/east_tc/start.sh s3://${BCKT_EAST}/jenkins/artifacts/builds/deploy/ods-extractor/tc/start.sh
aws s3 cp cloudFormation/ops/east_tc/TC_EAST.yaml s3://${BCKT_EAST}/jenkins/artifacts/builds/deploy/ods-extractor/tc/TC_EAST.yaml

aws s3 cp ${ARCHIVE_NAME} s3://${BCKT_WEST}/jenkins/artifacts/builds/deploy/ods-extractor/tc/${ARCHIVE_NAME}
aws s3 cp cloudFormation/ops/east_tc/start.sh s3://${BCKT_WEST}/jenkins/artifacts/builds/deploy/ods-extractor/tc/start.sh
aws s3 cp cloudFormation/ops/east_tc/TC_EAST.yaml s3://${BCKT_WEST}/jenkins/artifacts/builds/deploy/ods-extractor/tc/TC_WEST.yaml

echo "Xfer Up"
# UC to TC Transfer
aws s3 cp ${ARCHIVE_NAME} s3://${XFER_BCKT_EAST}/jenkins/artifacts/builds/deploy/ods-extractor/tc/${ARCHIVE_NAME}
aws s3 cp cloudFormation/ops/east_tc/start.sh s3://${XFER_BCKT_EAST}/jenkins/artifacts/builds/deploy/ods-extractor/tc/start.sh
aws s3 cp cloudFormation/ops/east_tc/TC_EAST.yaml s3://${XFER_BCKT_EAST}/jenkins/artifacts/builds/deploy/ods-extractor/tc/TC_EAST.yaml
