...
IMG_NAME="ods/extractor:latestScTst"
MACH_NAME="extractor"
...
aws s3 cp s3://ods-sa-t1/Reservoir_Dogs/Diode_Transfer_Service/UC-SC/jenkins/artifacts/builds/deploy/ods-extractor/sc/extractor-SC-TST.tgz /app/app.tgz
