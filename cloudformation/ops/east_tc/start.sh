...
aws s3 cp s3://ods-sa-01/Reservoir_Dogs/Diode_Transfer_Service/UC-TC/jenkins/artifacts/builds/deploy/ods-extractor/tc/extractor-TC-OPS.tgz /app/app.tgz --no-verify-ssl --region us-iso-east-1 
